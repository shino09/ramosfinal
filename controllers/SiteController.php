...
class SiteController extends Controller
{
 ...
 public function actionRegister()
 {
  ...
  $body .= "<a href='http://127.0.0.1/ramosfinal4/web/index.php?r=site/confirm&id=".$id."&authKey=".$authKey."'>Confirmar</a>";
    ...
    public function actionRecoverpass()
{
 ...
 if ($model->load(Yii::$app->request->post()))
 {
  ...
  $body .= "<p><a href='http://127.0.0.1/ramosfinal4/web/index.php?r=site/resetpass'>Recuperar password</a></p>";
